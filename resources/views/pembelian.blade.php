...
<div class="container-fluid"> @if(session('message')) <div class="alert alert-success m-3"> {{session('message')}}
        ...
        <tr>
            ...
            <td>
                ...
                </button> @elseif($p->status=='proses') <button class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#ModalUpdatepembelian{{
str_replace('/','',$p->kode_pembelian) }}">
    ...
    str_replace('/','',$p->kode_pembelian) }}">
        ...
        <div class="modal fade" id="ModalUpdatepembelian{{ str_replace('/','',$p->kode_pembelian) }}" tabindex="-1"
        ...
        <div class="modal fade" id="ModalDeletepembelian{{$p->kode_pembelian}}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/pembelian/delete/{{$p->kode_pembelian}}" method="get" class="form-floating">
                            @csrf <div>
